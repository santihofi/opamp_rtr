...
C {devices/code_shown.sym} 360 -300 0 0 {name=NGSPICE only_toplevel=true 
value="
.temp \{\{ temp \}\}
.param mc_ok = \{\{ sigma \}\}
.option SEED= \{\{ seed \}\}
...
C {simulator_commands_shown.sym} -320 -320 0 0 {
name=Libs_Ngspice1
simulator=ngspice
only_toplevel=false
value="
