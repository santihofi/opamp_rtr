...
F {}
E {}
N 650 70 650 90 {lab=#net1}
N 650 150 650 170 {lab=GND}
N 520 -80 540 -80 {lab=out_psr}
N 360 -60 380 -60 {lab=out_psr}
N 430 -30 430 -10 {lab=GND}
N 430 -150 430 -130 {lab=vdd}
N 450 -270 450 -250 {lab=vdd}
N 450 -190 450 -130 {lab=#net2}
N 520 -80 520 20 {lab=out_psr}
N 500 -80 520 -80 {lab=out_psr}
N 360 20 520 20 {lab=out_psr}
N 360 -60 360 20 {lab=out_psr}
N 280 -100 380 -100 {lab=vdin}
N 280 0 280 60 {lab=GND}
N 280 -100 280 -60 {lab=vdin}
N 650 -10 650 10 {lab=vdd}
N 520 20 520 40 {lab=out_psr}
...
C {devices/code_shown.sym} 710 -230 0 0 {name=NGSPICE only_toplevel=true 
value="
.temp \{\{ temp \}\}
.param mc_ok = \{\{ sigma \}\}
.option SEED = \{\{ seed \}\}
...
C {lab_pin.sym} 650 -10 3 1 {name=p6 sig_type=std_logic lab=vdd}
C {gnd.sym} 430 -10 0 0 {name=l4 lab=GND}
C {lab_pin.sym} 540 -80 2 0 {name=p28 sig_type=std_logic lab=out_psr}
...
C {vsource.sym} 650 40 0 0 {name=V1 value="pwl 0 0 1u 0 1.00001u -100m 5u -100m 5.00001u 0" savecurrent=false}
C {vsource.sym} 280 -30 0 0 {name=V3 value=\{\{vincm\}\} savecurrent=false}
...
C {simulator_commands_shown.sym} 130 190 0 0 {
name=Libs_Ngspice
simulator=ngspice
only_toplevel=false
value="
...
C {heichip/opamp_rtr/schematic/xschem/opamp_rtr.sym} 190 -330 0 0 {name=x1
spice_ignore=true}
C {heichip/opamp_rtr/schematic/xschem/opamp_rtr_pex.sym} 400 -40 0 0 {name=x2}
C {devices/code_shown.sym} -560 10 0 0 {name=inc only_toplevel=true 
value="
